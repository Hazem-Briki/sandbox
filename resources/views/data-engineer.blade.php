    ...
    <div class="container-object">
        @foreach ($exams as $index => $exam)
            <div class="container-question">
                <div class="question">
                    <div class="question-number">{{ ($exams->currentPage() - 1) * $exams->perPage() + $index + 1 }}</div>
                ...
                <div class="buttons">
                    <div class="show-answer"><button class="show-answer-btn" id="{{ $exam->answer }}">Show
                            Answer</button></div>
    ...
    <script>
        $(document).ready(function() {
            $('.show-answer-btn').on('click', function() {
                var $questionContainer = $(this).closest('.container-question').find(
                    '.question'); // Find the closest question container
                ...
                if ($(this).text() === 'Show Answer') {
                    ...
                    $questionContainer.find('.multi-choice-letter[data-choice-letter="' + correctAnswer +
